//Tailwind le quita la apariencia a los elementos para que vos 
//puedas agrgar esa apariencia
...
function App() {
  ...
  return (
    <>
      ...
      <main className="max-w-7xl mx-auto pt-20 max-w grid md:grid-cols-2">
